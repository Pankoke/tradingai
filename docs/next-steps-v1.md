...
Update 2026-02-03b: Backtest runs werden jetzt in 'backtest_runs' (runKey-unique, JSONB trades/kpis) persistiert; n�chster Schritt: UI/Explorer und ggf. normalisierte trades-Tabelle.
