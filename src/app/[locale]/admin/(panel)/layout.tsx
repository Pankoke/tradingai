...
import { AdminSidebar, type NavGroup } from "@/src/components/admin/AdminSidebar";
  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { href: `/${locale}/admin/outcomes`, label: messages["admin.nav.outcomesExplorer"] ?? "Outcomes Explorer" },
      ],
    },
    {
      label: "Playbooks",
      items: [
        ...
        { href: `/${locale}/admin/playbooks/calibration`, label: "Calibration" },
        { href: `/${locale}/admin/playbooks/thresholds`, label: "Thresholds" },
      ],
    },
    {
      label: "Outcomes",
      items: [
        { href: `/${locale}/admin/outcomes/overview`, label: "Overview (Artifact)" },
        { href: `/${locale}/admin/outcomes/diagnostics`, label: "Diagnostics" },
        { href: `/${locale}/admin/outcomes/engine-health`, label: "Engine Health" },
        { href: `/${locale}/admin/outcomes/swing-performance`, label: "Swing Performance", badge: "Legacy", subdued: true },
      ],
    },
    {
      ...
      items: [
        ...
        { href: `/${locale}/admin/marketdata`, label: messages["admin.nav.marketdataHealth"] ?? "Market Data Health" },
    ...
    {
      label: "Backtesting",
      items: [{ href: `/${locale}/admin/backtests`, label: "Backtests" }],
    },
  ];
