export const watchEnabledPlaybookIds = new Set<string>(["gold-swing-v0.2", "crypto-swing-v0.1"]);

export const hardReasonKeywords = ["event", "knockout", "conflict", "stale", "missing", "invalid", "rrr"];
export const softReasonKeywords = ["bias", "trend", "signal", "confidence", "quality", "confirmation", "chop", "alignment"];
...
export const tradeRequirementsByPlaybook: Record<string, string[]> = {
  ...
  "crypto-swing-v0.1": ["Bias ≥ 70", "Trend ≥ 50", "Signalqualität ≥ 55", "Confidence ≥ 60"],
};
