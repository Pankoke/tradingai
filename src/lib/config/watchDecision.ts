export const watchEnabledPlaybookIds = new Set<string>(["gold-swing-v0.2", "crypto-swing-v0.1", "spx-swing-v0.1"]);
...
export const tradeRequirementsByPlaybook: Record<string, string[]> = {
  ...
  "spx-swing-v0.1": ["Bias ≥ 70", "Trend ≥ 60", "Signalqualität ≥ 55", "Confidence ≥ 55"],
};
