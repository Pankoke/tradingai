...
export function computeLevelsForSetup(params: {
  ...
  return {
    ...
    debug: {
      ...
      refinementApplied,
      refinementAttempted,
      refinementAttemptReason: refinementAttempted ? "has_levels" : null,
      refinementSkippedReason: refinementAttempted ? (refinementApplied ? null : fallbackReason) : "trigger_skipped",
